			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="profile-label" class="property-label"><g:message code="user.profile.label" default="Profile" /></span>
						...
						<span class="property-value" aria-labelledby="profile-label"><g:link controller="profile" action="show" id="${userInstance?.profile?.id}">${userInstance?.profile?.displayString?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="following-label" class="property-label"><g:message code="user.following.label" default="Following" /></span>
						...
						<g:each in="${userInstance.following}" var="f">
							<span class="property-value" aria-labelledby="following-label"><g:link controller="user" action="show" id="${f.id}">${f?.displayString?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="posts-label" class="property-label"><g:message code="user.posts.label" default="Posts" /></span>
						...
						<g:each in="${userInstance.posts}" var="p">
							<span class="property-value" aria-labelledby="posts-label"><g:link controller="post" action="show" id="${p.id}">${p?.displayString?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="tags-label" class="property-label"><g:message code="user.tags.label" default="Tags" /></span>
						...
						<g:each in="${userInstance.tags}" var="t">
							<span class="property-value" aria-labelledby="tags-label"><g:link controller="tag" action="show" id="${t.id}">${t?.displayString?.encodeAsHTML()}</g:link></span>
						</g:each>
